...
class DiscordClient
{
	...
	public static function initialize()
	{
		...
		discordHandlers.ready = onReady.fromStaticFunction();
		discordHandlers.disconnected = onDisconnected.fromStaticFunction();
		discordHandlers.errored = onError.fromStaticFunction();
		Discord.Initialize(clientID, discordHandlers.addressOf(), true, null);
	...
	public inline static function updatePresence()
	{
