...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		progressTxt.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
...
class ResetAchievementSubstate extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		text.setFormat(Paths.font("vcr.ttf"), 40, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
		text.scrollFactor.set();
		text.borderSize = 2;
		add(text);
